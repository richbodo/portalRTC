...
var DrawingCanvas, STATE_END, STATE_MOVE, STATE_START, config, dataChannelConfig, servers, _ref, _ref1,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };

if (((_ref = Meteor.settings) != null ? (_ref1 = _ref["public"]) != null ? _ref1.servers : void 0 : void 0) != null) {
...
DrawingCanvas = (function() {
  function DrawingCanvas(_canvas) {
    ...
    this._renderStrokes = __bind(this._renderStrokes, this);
...
Template.drawer.rendered = function() {
  ...
  this._sendEventData = (function(_this) {
    return function(event, state) {
      var stroke, x, y, _ref2;
      if (((_ref2 = event.originalEvent) != null ? _ref2.changedTouches : void 0) != null) {
